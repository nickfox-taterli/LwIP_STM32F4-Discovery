...
#ifndef __STM32F4xx_LL_ETH_H
#define __STM32F4xx_LL_ETH_H
...
typedef enum
{
  LL_ETH_STATE_RESET             = 0x00U,    /*!< Peripheral not yet Initialized or disabled         */
  LL_ETH_STATE_READY             = 0x01U,    /*!< Peripheral Initialized and ready for use           */
  LL_ETH_STATE_BUSY              = 0x02U,    /*!< an internal process is ongoing                     */
  LL_ETH_STATE_BUSY_TX           = 0x12U,    /*!< Data Transmission process is ongoing               */
  LL_ETH_STATE_BUSY_RX           = 0x22U,    /*!< Data Reception process is ongoing                  */
  LL_ETH_STATE_BUSY_TX_RX        = 0x32U,    /*!< Data Transmission and Reception process is ongoing */
  LL_ETH_STATE_BUSY_WR           = 0x42U,    /*!< Write process is ongoing                           */
  LL_ETH_STATE_BUSY_RD           = 0x82U,    /*!< Read process is ongoing                            */
  LL_ETH_STATE_TIMEOUT           = 0x03U,    /*!< Timeout state                                      */
  LL_ETH_STATE_ERROR             = 0x04U     /*!< Reception process is ongoing                       */
}LL_ETH_StateTypeDef;
...
/** 
  ...
  */
#define __LL_ETH_DMATXDESC_GET_FLAG(__HANDLE__, __FLAG__)             ((__HANDLE__)->TxDesc->Status & (__FLAG__) == (__FLAG__))
...
/**
  ...
  * @retval the ETH_DMATxDescFlag (SET or RESET).
  */
#define __LL_ETH_DMARXDESC_GET_FLAG(__HANDLE__, __FLAG__)             ((__HANDLE__)->RxDesc->Status & (__FLAG__) == (__FLAG__))
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMARXDESC_ENABLE_IT(__HANDLE__)                          ((__HANDLE__)->RxDesc->ControlBufferSize &=(~(uint32_t)ETH_DMARXDESC_DIC))
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMARXDESC_DISABLE_IT(__HANDLE__)                         ((__HANDLE__)->RxDesc->ControlBufferSize |= ETH_DMARXDESC_DIC)
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMARXDESC_SET_OWN_BIT(__HANDLE__)                           ((__HANDLE__)->RxDesc->Status |= ETH_DMARXDESC_OWN)
...
/**
  ...
  */
#define __LL_ETH_DMATXDESC_GET_COLLISION_COUNT(__HANDLE__)                   (((__HANDLE__)->TxDesc->Status & ETH_DMATXDESC_CC) >> ETH_DMATXDESC_COLLISION_COUNTSHIFT)
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMATXDESC_SET_OWN_BIT(__HANDLE__)                       ((__HANDLE__)->TxDesc->Status |= ETH_DMATXDESC_OWN)
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMATXDESC_ENABLE_IT(__HANDLE__)                          ((__HANDLE__)->TxDesc->Status |= ETH_DMATXDESC_IC)
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMATXDESC_DISABLE_IT(__HANDLE__)                          ((__HANDLE__)->TxDesc->Status &= ~ETH_DMATXDESC_IC)
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMATXDESC_CHECKSUM_INSERTION(__HANDLE__, __CHECKSUM__)     ((__HANDLE__)->TxDesc->Status |= (__CHECKSUM__))
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMATXDESC_CRC_ENABLE(__HANDLE__)                          ((__HANDLE__)->TxDesc->Status &= ~ETH_DMATXDESC_DC)
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMATXDESC_CRC_DISABLE(__HANDLE__)                         ((__HANDLE__)->TxDesc->Status |= ETH_DMATXDESC_DC)
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMATXDESC_SHORT_FRAME_PADDING_ENABLE(__HANDLE__)            ((__HANDLE__)->TxDesc->Status &= ~ETH_DMATXDESC_DP)
...
/**
  ...
  * @retval None
  */
#define __LL_ETH_DMATXDESC_SHORT_FRAME_PADDING_DISABLE(__HANDLE__)           ((__HANDLE__)->TxDesc->Status |= ETH_DMATXDESC_DP)
